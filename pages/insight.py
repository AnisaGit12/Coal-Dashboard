...
home_page = st.Page("pages/home.py", title="Dashboard Utama", icon="🏠", default=True)
prod_page = st.Page("pages/production.py", title="Tren Produksi", icon="📊")
clust_page = st.Page("pages/clustering.py", title="Analisis K-Means", icon="⛏️")
report_page = st.Page("pages/report.py", title="Laporan Akhir", icon="📄")
